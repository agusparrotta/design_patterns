...
class Strategy:
    ...
    def execute(self) -> None:  # This gets replaced by another version if another strategy is provided
        ...
        logging.info('{} is used!'.format(self.name))


# Replacement method 1
def strategy_one(self) -> None:
    logging.info('{} is used to execute method 1'.format(self.name))


# Repĺacement method 2
def strategy_two(self) -> None:
    logging.info('{} is used to execute method 2'.format(self.name))
